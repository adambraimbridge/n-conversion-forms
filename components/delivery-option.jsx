...
export function DeliveryOption ({
	...
	const deliveryOptions = {
		PV: {
			...
			description: '13-week voucher pack delivered quarterly and redeemable at retailers nationwide. COVID-19 - make sure your preferred newsagent or retailer is open and/or delivering before you select this option. Stay safe!'
		},
		HD: {
			title: 'Home delivery',
